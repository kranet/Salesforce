({
	...
	var message = component.get("v.selectRecordId");
    //window.postMessage(message, "https://apprl--c.visualforce.com");
	sforce.one.showToast({
    "title": "Success!",
    "message": "Creators added to this campaign!"
		});
     sforce.one.navigateToSObject(message,'view');
    },
})
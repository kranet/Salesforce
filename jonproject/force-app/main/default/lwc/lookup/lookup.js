...
export default class Lookup extends LightningElement {
    ...
    setSearchResults(results) {
        // Reset the spinner
        this.loading = false;
        let resultmock = Object.assign({}, results);

        this.searchResults = results.map((result) => {
            //Spring 20 made object.assign necessary, otherwise result is immutable.
            result = Object.assign({}, result);
            // Clone and complete search result if icon is missing. First part allows for mutation of db data.
    ...
    updateSearchTerm(newSearchTerm) {
        console.log('Changing search term: '+newSearchTerm);
        console.log('Previous term:' +this.searchTerm);
